const Layout = ({ children }) => {
  return (
    <div>
      <div className="bg-gray-dark h-full">{children}</div>
      <footer className="bg-gray-light text-white px-6 lg:px-8 py-12">
        <div className="max-w-screen-xl mx-auto grid md:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-x-8">
          <div>
            <img
              className="h-8"
              src="./images/uptimemate-logo.svg"
              alt="Stop Mo Blog Logo"
            />
            <p className="mt-4 tracking-widest font-light">HELLO BLOG</p>
          </div>
          <div>
            ...
            <nav className="mt-4">
              <ul className="space-y-2">
                <li>
                  <a href="#" className=" text-base hover:text-yellow">
                ...
                <li>
                  <a href="#" className=" text-base hover:text-gray-100">
                    Privacy Statement
                  </a>
                </li>
              </ul>
        ...
        <div className="max-w-screen-xl mx-auto flex flex-col items-center mt-16">
          ...
          <div className="text-sm mt-4">
            &copy;2021 StopMoBlog. All rights reserved.
          </div>
        </div>
      </footer>
    </div>
